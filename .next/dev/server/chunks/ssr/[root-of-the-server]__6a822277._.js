...
function CustomerChatPage() {
    ...
    const handleStartChat = async (email)=>{
        ...
        const existingConversation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].getConversationByBusinessAndPhone(business.id, phone);
        if (existingConversation) {
            // Update email if provided and different
            if (email && existingConversation.customerEmail !== email) {
                const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"].updateConversation(existingConversation.id, {
                    customerEmail: email
                });
                if (updated) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"].createConversation(newConversation, phone);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a822277._.js.map