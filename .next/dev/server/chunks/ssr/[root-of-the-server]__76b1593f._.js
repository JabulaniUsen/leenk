...
function SettingsPage() {
    ...
    const handleSave = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"].updateBusiness(auth.business.id, {
                businessName,
                phone,
                address,
                online,
            ...
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"].getBusinessById(auth.business.id);
            if (updated) {
                setAuth({
                    ...auth,
                    business: updated
    ...
    const handleImageSelect = async (e)=>{
        ...
        try {
            ...
            const imageUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2d$upload$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadBusinessLogo"])(file, auth.business.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__76b1593f._.js.map