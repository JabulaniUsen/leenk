...
function CustomerChatPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadBusiness = async ()=>{
            const biz = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"].getBusinessByPhone(phone);
            if (!biz) {
    ...
    const handleEmailSearch = async (email)=>{
        ...
        try {
            ...
            if (existingConversation) {
                // Email found - auto-populate name and load conversation
                ...
                // Email not found - show name input
    ...
    const handleStartChat = async (e)=>{
        ...
        // If name input is not shown yet, this means we need to search first
        if (!showNameInput && !conversation) {
            await handleEmailSearch(customerEmail);
            return;
        }
        // If name input is shown, name is required
        if (showNameInput && !customerName.trim()) {
            setError("Please provide your name");
            return;
        }
        setError("");
        // If conversation already exists (from email search), we're done
        if (conversation) {
            // Update name if it was changed
            if (customerName.trim() && conversation.customerName !== customerName.trim()) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"].updateConversation(conversation.id, {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!conversation?.id || !business) return;
        // Mark all business messages as read when customer views the conversation
        const markAsRead = async ()=>{
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].markMessagesAsRead(conversation.id, "business");
    ...
    // Set up real-time WebSocket subscription when conversation is loaded
    const setupRealtimeSubscription = ()=>{
        ...
        const channel = supabaseRef.current.channel(channelName, {
            ...
            // Only show typing indicator if it's from the business user
            if (payload.payload.senderType === "business") {
            ...
            if (payload.eventType === "INSERT" || payload.eventType === "UPDATE") {
                try {
                    ...
                    // If it's a new message from the business, mark it as delivered
                    if (payload.eventType === "INSERT" && newMessage.senderType === "business") {
                    ...
                    setConversation((prev)=>{
                        ...
                        // If it's a new message from the business, clear typing indicator
                        if (existingIndex < 0 && newMessage.senderType === "business") {
                            setOtherUserTyping(false);
                            if (otherUserTypingTimeoutRef.current) {
                                clearTimeout(otherUserTypingTimeoutRef.current);
                            }
    ...
    const handleSendMessage = async (text)=>{
        ...
        setConversation(optimisticConv);
        setIsTyping(false);
        try {
    ...
    const handleTyping = ()=>{
        ...
        if (channelRef.current && conversation?.id && !typingBroadcastThrottleRef.current) {
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            className: "h-screen flex flex-col bg-[var(--chat-bg)] dark:bg-[var(--chat-bg)]",
            children: [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    !conversation || conversation.messages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f272116d._.js.map