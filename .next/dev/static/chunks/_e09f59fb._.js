    ...
    async createMessage (message) {
        ...
        if (message.senderType === "customer") {
            ...
            if (convData?.business_id) {
                // Import and call away message function (fire and forget)
                __turbopack_context__.A("[project]/lib/away-message.ts [app-client] (ecmascript, async loader)").then(({ sendAwayMessageIfEnabled })=>{
                    sendAwayMessageIfEnabled(message.conversationId, convData.business_id).catch((err)=>console.error("Error sending away message:", err));
                });
            }
        }
        return {
...
_s(ProfileTabComponent, "MTfmfMr0BtFwt1EQSz2gzBYXjfE=", false, function() {
    return [
...
//# sourceMappingURL=_e09f59fb._.js.map