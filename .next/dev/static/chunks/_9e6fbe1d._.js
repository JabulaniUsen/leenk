...
_s(MessageInput, "46blIHDgVY0F54SzFnh7AcVI8As=");
_c = MessageInput;
var _c;
...
function CustomerChatPage() {
    ...
    const handleStartChat = async (email)=>{
        if (!business) return;
        // Try to find existing conversation by customer phone
        const existingConversation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getConversationByBusinessAndPhone(business.id, phone);
        if (existingConversation) {
            // Update email if provided and different
            if (email && existingConversation.customerEmail !== email) {
                const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].updateConversation(existingConversation.id, {
                    customerEmail: email
                });
                if (updated) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].createConversation(newConversation, phone);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomerChatPage.useEffect": ()=>{
            ...
            const channel = supabase.channel(`conversation:${conversation.id}`).on("postgres_changes", {
                event: "INSERT",
                schema: "public",
                table: "messages",
                filter: `conversation_id=eq.${conversation.id}`
            }, {
                "CustomerChatPage.useEffect.channel": async (payload)=>{
            ...
            }["CustomerChatPage.useEffect.channel"]).subscribe();
            return ({
                "CustomerChatPage.useEffect": ()=>{
...
_s(CustomerChatPage, "qNoDOO55QNvG5yBfZ0qVaiO+YuI=", false, function() {
    return [
...
//# sourceMappingURL=_9e6fbe1d._.js.map