...
function SettingsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            const loadAuth = {
                "SettingsPage.useEffect.loadAuth": async ()=>{
                    setAuthLoading(true);
                    try {
                        ...
                        if (!authUser) {
                            ...
                            setOnline(authUser.business.online);
                            setProfilePicture(authUser.business.businessLogo || "");
                        }
                    } catch (error) {
            ...
            }["SettingsPage.useEffect.loadAuth"];
            if (!initialized) {
                loadAuth();
    ...
    const handleSave = async (e)=>{
        ...
        try {
            ...
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getBusinessById(user.business.id);
            if (updated && user) {
                setUser({
                    ...user,
                    business: updated
...
_s(SettingsPage, "zchTDbxPK8uYaHfzjgE1WzTT8oc=", false, function() {
    return [
...
//# sourceMappingURL=_e8b9a8de._.js.map