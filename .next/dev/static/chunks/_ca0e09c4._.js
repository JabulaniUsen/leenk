...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            if (user && user.business && conversations.length === 0 && !conversationsLoading && initialized) {
                const loadConversations = {
                    "DashboardPage.useEffect.loadConversations": async ()=>{
                        setConversationsLoading(true);
                        try {
                ...
                }["DashboardPage.useEffect.loadConversations"];
                loadConversations();
            }
        }
    }["DashboardPage.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            ...
            const refreshConversations = {
                "DashboardPage.useEffect.refreshConversations": async ()=>{
                    try {
                        const convs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationsByBusinessId(user.id);
                        setConversations(convs);
                    } catch (error) {
...
_s(DashboardPage, "Y0KEGPdQ5ODkVTvG7FVe/5/kVRs=", false, function() {
    return [
...
//# sourceMappingURL=_ca0e09c4._.js.map