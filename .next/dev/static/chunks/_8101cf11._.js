        ...
        "ChatPage.useEffect": ()=>{
            ...
            const handleMessageUpdate = {
                "ChatPage.useEffect.handleMessageUpdate": (message)=>{
                    ...
                    }["ChatPage.useEffect.handleMessageUpdate"], false); // false = don't revalidate, we'll let realtime handle it
                    ...
                    }["ChatPage.useEffect.handleMessageUpdate"], false);
                }
            }["ChatPage.useEffect.handleMessageUpdate"];
            const handleMessageDelete = {
                "ChatPage.useEffect.handleMessageDelete": (messageId)=>{
                    ...
                    }["ChatPage.useEffect.handleMessageDelete"], false);
                    mutateConversations({
                        "ChatPage.useEffect.handleMessageDelete": (current)=>{
                            if (!current) return current;
                            return current.map({
...
//# sourceMappingURL=_8101cf11._.js.map