    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            if (user?.business?.id) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].updateBusiness(user.business.id, {
                    online: true
                }).then({
                    "DashboardPage.useEffect": ()=>{
            ...
            const handleBeforeUnload = {
                "DashboardPage.useEffect.handleBeforeUnload": ()=>{
                    if (user?.business?.id) {
...
_s(DashboardPage, "qXZvf8mKzh9Xum3IDPNpZSO+BZg=", false, function() {
    return [
...
//# sourceMappingURL=_2dbba43d._.js.map