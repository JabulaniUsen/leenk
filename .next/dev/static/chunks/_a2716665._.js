...
/**
 * EGRESS OPTIMIZATION: Compress images before upload to reduce storage egress
 * This can reduce image file sizes by 70-90%, significantly reducing egress costs
 */ __turbopack_context__.s([
    "compressImage",
    ()=>compressImage,
    ...
    return new Promise((resolve, reject)=>{
        ...
        reader.onload = (e)=>{
            ...
            img.onload = ()=>{
                ...
                }, file.type || "image/jpeg", opts.quality);
            };
...
function getEstimatedCompressionRatio(originalSize) {
    // Typical compression: 70-90% reduction for photos
    // More conservative estimate: 60% reduction
    return originalSize * 0.4;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
async function uploadBusinessLogo(file, businessId) {
    ...
    // EGRESS OPTIMIZATION: Compress logo before upload
    let fileToUpload = file;
    try {
        fileToUpload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$compression$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compressImage"])(file, {
            maxWidth: 800,
            maxHeight: 800,
            quality: 0.85,
            maxSizeMB: 0.5
        });
        console.log(`📦 Logo compressed: ${(file.size / 1024).toFixed(2)}KB → ${(fileToUpload.size / 1024).toFixed(2)}KB`);
    } catch (error) {
        console.warn("Logo compression failed, uploading original:", error);
    }
    ...
    // Upload the compressed file to business_logo bucket
    const { data, error } = await supabase.storage.from("business_logo").upload(filePath, fileToUpload, {
        cacheControl: "3600",
        upsert: false
    });
    if (error) {
...
async function uploadImage(file, folder, businessId) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    // EGRESS OPTIMIZATION: Compress image before upload (reduces egress by 70-90%)
    let fileToUpload = file;
    try {
        fileToUpload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$compression$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compressImage"])(file, {
            maxWidth: 1920,
        ...
        console.log(`📦 Image compressed: ${(file.size / 1024).toFixed(2)}KB → ${(fileToUpload.size / 1024).toFixed(2)}KB (${((1 - fileToUpload.size / file.size) * 100).toFixed(1)}% reduction)`);
    } catch (error) {
...
//# sourceMappingURL=_a2716665._.js.map