...
function ChatPage() {
    ...
    const typingBroadcastThrottleRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            const loadData = {
                "ChatPage.useEffect.loadData": async ()=>{
                    ...
                    setAuth(authUser);
                    const conv = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationById(conversationId);
                    if (!conv) {
                        router.push("/dashboard");
                        return;
                    }
                    setConversation(conv);
                    const convs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationsByBusinessId(authUser.id);
                    setConversations(convs);
                    setLoading(false);
                }
            }["ChatPage.useEffect.loadData"];
            loadData();
        }
    }["ChatPage.useEffect"], [
        conversationId,
        ...
        const channel = supabaseRef.current.channel(channelName, {
            ...
            if (payload.eventType === "INSERT" || payload.eventType === "UPDATE") {
                try {
                    ...
                    const currentAuth = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getAuth();
                    if (currentAuth) {
                        const convs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationsByBusinessId(currentAuth.id);
                        setConversations(convs);
                    }
                } catch (error) {
            ...
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationById(conversationId);
            if (updated) {
        ...
        "ChatPage.useEffect": ()=>{
            ...
            const pollInterval = setInterval({
                "ChatPage.useEffect.pollInterval": async ()=>{
                    try {
                        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationById(conversation.id);
            ...
            }["ChatPage.useEffect.pollInterval"], 5000) // Poll every 5 seconds when disconnected
            ;
            return ({
                "ChatPage.useEffect": ()=>{
    ...
    const handleSendMessage = async (text)=>{
        ...
        try {
            ...
            setTimeout(async ()=>{
                const convs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationsByBusinessId(auth.id);
                setConversations(convs);
            }, 500);
        } catch (error) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            conversation.messages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ChatPage, "2ewVexifgzlr///10ET6ksmI5/0=", false, function() {
    return [
...
//# sourceMappingURL=_680cbb34._.js.map