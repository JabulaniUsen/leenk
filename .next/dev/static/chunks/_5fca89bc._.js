...
function DashboardPage() {
    ...
    const loadConversations = (businessId)=>{
        const convs = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationsByBusinessId(businessId);
        setConversations(convs);
        setLoading(false);
    };
    const handleLogout = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].clearAuth();
        router.push("/");
    };
    if (!auth) return null;
...
_s(DashboardPage, "HhIS5Pi8rvuvrsLvTMvvg+SBUXY=", false, function() {
    return [
...
//# sourceMappingURL=_5fca89bc._.js.map