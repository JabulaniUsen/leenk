...
function DashboardPage() {
    ...
    const [notesConversation, setNotesConversation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            ...
            const loadNotes = {
                "DashboardPage.useEffect.loadNotes": async ()=>{
                    try {
                        const notes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrCreateNotesConversation"])(user.business.id);
                        setNotesConversation(notes);
                    } catch (error) {
                        console.error("Error loading notes conversation:", error);
                    }
                }
            }["DashboardPage.useEffect.loadNotes"];
            loadNotes();
        }
    }["DashboardPage.useEffect"], [
        user?.business?.id
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            ...
            const refreshNotes = {
                "DashboardPage.useEffect.refreshNotes": async ()=>{
                    try {
                        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationById(notesConversation.id);
                        if (updated) {
            ...
            }["DashboardPage.useEffect.refreshNotes"];
            // Refresh notes when conversations list updates
            refreshNotes();
        }
    }["DashboardPage.useEffect"], [
        conversations,
...
_s(DashboardPage, "hh6ReVToH1tUFb/OGmzxhQzvZl0=", false, function() {
    return [
...
//# sourceMappingURL=_4f756822._.js.map