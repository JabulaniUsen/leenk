...
function CustomerChatPage() {
                ...
                "CustomerChatPage.useEffect.handleMessageUpdate": (message)=>{
                    ...
                    if (existingIndex >= 0) {
                        ...
                        const updatedMessages = [
                            ...
                            "CustomerChatPage.useEffect.handleMessageUpdate.updatedMessages": (a, b)=>new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime()
                        }["CustomerChatPage.useEffect.handleMessageUpdate.updatedMessages"]);
                        setCurrentConversation({
                            ...currentConversation,
    ...
    const handleSendMessage = async (text)=>{
        ...
        try {
            ...
            // Replace temp message with real message (with server ID)
            if (currentConversation) {
...
_s(CustomerChatPage, "mMpzhMaodkK9BNONULUpAx5R1AY=", false, function() {
    return [
...
//# sourceMappingURL=_ea4fcc67._.js.map