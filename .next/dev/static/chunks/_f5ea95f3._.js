...
function SettingsPage() {
    ...
    const handleSave = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].updateBusiness(auth.business.id, {
                businessName,
                phone,
                address,
                online,
            ...
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getBusinessById(auth.business.id);
            if (updated) {
                setAuth({
                    ...auth,
                    business: updated
    ...
    const handleImageSelect = async (e)=>{
        ...
        try {
            ...
            const imageUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2d$upload$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadBusinessLogo"])(file, auth.business.id);
    ...
    const handleRemoveImage = async ()=>{
        if (!profilePicture || !auth?.business) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2d$upload$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteBusinessLogo"])(profilePicture);
            setProfilePicture("");
...
_s(SettingsPage, "+MYxzj7CRncz9dds57fNpC6YrVI=", false, function() {
    return [
...
//# sourceMappingURL=_f5ea95f3._.js.map