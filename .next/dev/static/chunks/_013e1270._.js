...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        try {
            ...
            if (existingBusinesses.some((b)=>b.email === email)) {
                setError("Email already registered");
                return;
            }
            const businessId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
            const newBusiness = {
                id: businessId,
                email,
                phone: "",
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].createBusiness(newBusiness);
...
_s(SignupPage, "NbI/oFFgpuM4ODQKe6kFuWPwwYU=", false, function() {
    return [
...
//# sourceMappingURL=_013e1270._.js.map