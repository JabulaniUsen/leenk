...
const BUSINESSES_KEY = "leenk_businesses";
const CONVERSATIONS_KEY = "leenk_conversations";
const AUTH_KEY = "leenk_auth";
const storage = {
    // Businesses
    getAllBusinesses: ()=>{
        const data = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem(BUSINESSES_KEY) : "TURBOPACK unreachable";
        return data ? JSON.parse(data) : [];
    },
    getBusinessByPhone: (phone)=>{
        const businesses = storage.getAllBusinesses();
        return businesses.find((b)=>b.phone === phone) || null;
    },
    getBusinessById: (id)=>{
        const businesses = storage.getAllBusinesses();
    ...
    getConversationsByBusinessId: (businessId)=>{
        const data = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem(CONVERSATIONS_KEY) : "TURBOPACK unreachable";
    ...
    // Auth
    getAuth: ()=>{
        const data = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem(AUTH_KEY) : "TURBOPACK unreachable";
...
function CustomerChatPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomerChatPage.useEffect": ()=>{
            const biz = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getBusinessByPhone(phone);
            if (!biz) {
    ...
    const handleStartChat = (email)=>{
        if (!business) return;
        const existingConversations = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationsByBusinessId(business.id).filter((c)=>c.customerEmail === (email || null));
        if (existingConversations.length > 0) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].createConversation(newConversation);
    ...
    const handleSendMessage = (text)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].updateConversation(conversation.id, updated);
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    children: "Continue without email"
                                }, void 0, false, {
                                    fileName: "[project]/app/chat/[phone]/page.tsx",
                                    lineNumber: 164,
                                    columnNumber: 15
...
_s(CustomerChatPage, "0njw336v4NSG+kbMbnBJD8h+mi4=", false, function() {
    return [
...
//# sourceMappingURL=_d0481d14._.js.map