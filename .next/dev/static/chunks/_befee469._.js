...
"[project]/lib/notes.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getNotesConversationId",
    ()=>getNotesConversationId,
    "getOrCreateNotesConversation",
    ()=>getOrCreateNotesConversation,
    "isNotesConversation",
    ()=>isNotesConversation,
    "isNotesConversationById",
    ()=>isNotesConversationById
]);
...
;
;
const NOTES_EMAIL_PREFIX = "notes@";
const NOTES_NAME = "Notes";
// Store notes conversation IDs in memory (businessId -> conversationId)
// This allows us to use proper UUIDs while still identifying notes conversations
const notesConversationIdMap = new Map();
function getNotesConversationId(businessId) {
    if (!notesConversationIdMap.has(businessId)) {
        notesConversationIdMap.set(businessId, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])());
    }
    return notesConversationIdMap.get(businessId);
}
function isNotesConversation(conversation) {
    if (typeof conversation === "string") {
        // For string IDs, we can't determine from just the ID
        // This will be checked when we have the full conversation object
        // Return false for now - the check will happen when conversation is loaded
        return false;
    }
    // Check by email pattern (most reliable)
    return conversation.customerEmail?.startsWith(NOTES_EMAIL_PREFIX) || false;
}
async function isNotesConversationById(conversationId, businessId) {
    try {
        ...
        if (conversation) {
            return isNotesConversation(conversation);
        }
        // If conversation doesn't exist, check if the email pattern matches
        const notesEmail = `${NOTES_EMAIL_PREFIX}${businessId}.local`;
        // We can't check without the conversation, so return false
        return false;
    } catch  {
        return false;
    }
}
async function getOrCreateNotesConversation(businessId) {
    const notesEmail = `${NOTES_EMAIL_PREFIX}${businessId}.local`;
    // First, try to find existing notes conversation by email pattern
    try {
        ...
        const existingNotes = conversations.find((conv)=>conv.customerEmail === notesEmail);
        if (existingNotes) {
            // Cache the ID for future lookups
            notesConversationIdMap.set(businessId, existingNotes.id);
            return existingNotes;
        }
    } catch (error) {
        console.error("Error fetching conversations to find notes:", error);
    }
    // If not found, create a new notes conversation with a proper UUID
    const notesId = getNotesConversationId(businessId);
    const notesConversation = {
        id: notesId,
        businessId,
        customerEmail: notesEmail,
        customerName: NOTES_NAME,
        createdAt: new Date().toISOString(),
        lastMessageAt: new Date().toISOString(),
        messages: []
    };
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].createConversation(notesConversation);
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getConversationById(notesId);
        if (created) {
            return created;
        }
    } catch (error) {
        // Log detailed error information
        console.error("Error creating notes conversation:", {
            error,
        ...
        // In that case, try to find it by email pattern
        if (error?.code === "23505" || error?.message?.includes("duplicate") || error?.message?.includes("unique")) {
            try {
                ...
                console.error("Error fetching existing notes conversation:", fetchError);
            }
        }
    // If creation fails, return the conversation object anyway
    // It will be created on first message send
    }
    return notesConversation;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/notes.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
;
;
function ChatBubble({ message, isOwn, index, onReply, conversationId }) {
    _s();
    ...
    const isNotes = conversationId ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNotesConversation"])(conversationId) : false;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    ...
                    message.text && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm md:text-base break-words flex-1",
                            ...
                            isNotes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: handleCopy,
                                className: "p-1.5 hover:bg-black/10 dark:hover:bg-white/10 rounded transition-colors flex-shrink-0",
                                title: "Copy message",
...
_s(ChatBubble, "hkV1hjZTs9F6dOjXLpIQI/eH5Lc=", false, function() {
    return [
...
function ConversationList({ conversations, selectedId, notesConversation }) {
    // Filter out notes from regular conversations
    const regularConversations = conversations.filter((conv)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNotesConversation"])(conv));
    const sorted = [
    ...
    const renderConversation = (conv, index, isNotes = false)=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: `p-3 md:p-4 border-b border-border hover:bg-secondary transition-colors cursor-pointer active:bg-secondary/50 ${selectedId === conv.id ? "bg-secondary" : ""} ${hasUnread ? "bg-primary/10 hover:bg-primary/20 border-l-4 border-l-primary" : ""}`,
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex gap-3 items-start",
                        children: [
                            isNotes ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center gap-2 ml-2",
                                                children: [
                                                    hasUnread && !isNotes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    !isNotes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
        ...
        children: [
            notesConversation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                initial: {
                    opacity: 0,
                    x: -20
                },
                ...
                children: renderConversation(notesConversation, 0, true)
            }, void 0, false, {
                fileName: "[project]/components/conversation-list.tsx",
                lineNumber: 102,
                columnNumber: 9
            }, this),
            sorted.length === 0 && !notesConversation ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                lineNumber: 112,
                columnNumber: 9
            }, this) : sorted.map((conv, index)=>renderConversation(conv, index + (notesConversation ? 1 : 0)))
        ]
    }, void 0, true, {
        fileName: "[project]/components/conversation-list.tsx",
        lineNumber: 99,
...
function useConversations(businessId) {
    _s();
    const { data, error, isLoading, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(businessId ? [
        `conversations`,
        businessId
    ] : null, {
...
//# sourceMappingURL=_befee469._.js.map